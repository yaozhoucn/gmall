...
public class AttrGroupController {
    ...
    @GetMapping("/{catId}")
    public Resp<PageVo> querGroupBypage(QueryCondition queryCondition,@PathVariable("catId")Long catId){

        PageVo page = attrGroupService.querGroupBypage(queryCondition,catId);
        return Resp.ok(page);
    }
